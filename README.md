...
| **View** | Chrome light/dark (sun/moon next to Pan); separate **dark (negative print)** on the left rail — sheet pixels inverted at draw time, persists per browser |
