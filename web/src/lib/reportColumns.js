...
export const GETTERS = {
  ...
  wall_footprint_sf: (r) => r.wall_footprint_sf,
  wall_volume_cf: (r) => r.wall_volume_cf,
...
export const TABLE_PROFILE = [
  ...
  { key: "wall_footprint_sf", header: "Wall Footprint SF", defaultVisible: false },
  { key: "wall_volume_cf",    header: "Wall Volume CF",    defaultVisible: false },
