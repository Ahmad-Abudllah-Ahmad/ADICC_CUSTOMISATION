...
async function downloadProgressReport(
  ...
  htmlParts.push(`<p class="footer">${esc(t('reports.html_footer', { defaultValue: 'Report generated by ADICC ERP on {{date}}', date: new Date().toLocaleString(lang) }))}</p>`);
        ...
        <CustomReportBuilder
          ...
          onGenerate={async () => {
            ...
            try {
              ...
              htmlParts.push(`<p class="generated">${esc(t('reports.html_footer', { defaultValue: 'Report generated by ADICC ERP on {{date}}', date: new Date().toLocaleString(lang) }))}</p>`);
              htmlParts.push('</body></html>');
